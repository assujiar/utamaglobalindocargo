...
const SERVICE_KEY = "international";
const ROUTE_KEY = "service-international";
...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    pageKey: ROUTE_KEY,
    locale: LOCALE,
    title: detail.seo.title_id,
    description: detail.seo.description_id,
  });
}
...
function ServiceSchema() {
  ...
  const jsonLd = {
    ...
    url: `https://utamaglobalindocargo.com/id/layanan/${service.slug_id}`,
  };
